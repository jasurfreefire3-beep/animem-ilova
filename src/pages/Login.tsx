          ...
          <>
            ...
            <div className="mt-6">
              ...
              <button
                ...
                className="w-full bg-white text-gray-900 hover:bg-gray-100 font-bold py-3 px-4 rounded-md transition-all mt-6 flex items-center justify-center gap-3 cursor-pointer shadow-sm hover:shadow active:scale-[0.99]"
              >
                ...
                <span className="text-sm font-semibold tracking-wide">Google bilan kirish</span>
              </button>
