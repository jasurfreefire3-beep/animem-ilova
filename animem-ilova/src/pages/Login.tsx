        ...
        {viewMode === 'login' && (
          <>
            ...
            <div className="mt-6">
              ...
              <button type="button" onClick={handleGoogleLogin} className="w-full bg-white text-black hover:bg-gray-100 font-bold py-3 px-4 rounded-sm transition-colors mt-6 flex items-center justify-center gap-3 cursor-pointer">
              ...
              <button type="button" onClick={handleFacebookLogin} className="w-full bg-[#1877F2] hover:bg-[#145fc4] text-white font-bold py-3 px-4 rounded-sm transition-colors mt-3 flex items-center justify-center gap-3 cursor-pointer">
              ...
              <button type="button" onClick={handleDiscordLoginStart} className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white font-bold py-3 px-4 rounded-sm transition-colors mt-3 flex items-center justify-center gap-3 cursor-pointer">
                Discord bilan kirish
              </button>
              <button type="button" onClick={handleTelegramLoginStart} className="w-full bg-[#0088cc] hover:bg-[#0077b5] text-white font-bold py-3 px-4 rounded-sm transition-colors mt-3 flex items-center justify-center gap-3 cursor-pointer">
                Telegram bilan kirish
              </button>
              <button type="button" onClick={handleYandexLoginStart} className="w-full bg-[#FC3F1D] hover:bg-[#e03415] text-white font-bold py-3 px-4 rounded-sm transition-colors mt-3 flex items-center justify-center gap-3 cursor-pointer shadow-md">
                Yandex bilan kirish
              </button>
            </div>
