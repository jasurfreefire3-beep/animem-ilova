      ...
      >
        ...
        {signupMethod === 'options' && (
          <div className="space-y-3.5">
            <p className="text-xs font-bold text-white/50 text-center uppercase tracking-wider mb-2">Ro'yxatdan o'tish usulini tanlang:</p>
            <button onClick={() => { setSignupMethod('email'); setEmailStep('email'); setError(''); setResendMessage(''); }} className="w-full bg-[#18181c] hover:bg-[#222] border border-[#ff006a]/40 hover:border-[#ff006a] p-4 rounded-sm transition-all text-left text-sm font-black text-white cursor-pointer">Email bilan ro'yxatdan o'tish <span className="block mt-1 text-[11px] font-normal text-white/40">Emailga 6 xonali kod yuboriladi</span></button>
            <button onClick={handleGoogleLogin} className="w-full bg-white text-black hover:bg-gray-100 p-4 rounded-sm transition-all text-left text-sm font-black cursor-pointer">Google bilan kirish</button>
            <button onClick={handleFacebookLogin} className="w-full bg-[#1877F2] hover:bg-[#145fc4] text-white p-4 rounded-sm transition-all text-left text-sm font-black cursor-pointer">Facebook bilan kirish</button>
            <button onClick={handleDiscordLoginStart} className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white p-4 rounded-sm transition-all text-left text-sm font-black cursor-pointer">Discord bilan kirish</button>
            <button onClick={handleTelegramLoginStart} className="w-full bg-[#0088cc] hover:bg-[#0077b5] text-white p-4 rounded-sm transition-all text-left text-sm font-black cursor-pointer">Telegram bilan kirish</button>
            <button onClick={handleYandexLoginStart} className="w-full bg-[#FC3F1D] hover:bg-[#e03415] text-white p-4 rounded-sm transition-all text-left text-sm font-black cursor-pointer">Yandex ID bilan kirish</button>
          </div>
        )}
        ...
        {signupMethod === 'email' && emailStep === 'email' && (
          <div>
            <button onClick={() => { setSignupMethod('options'); setError(''); }} className="flex items-center gap-1.5 text-xs text-white/50 hover:text-white mb-4 transition-colors cursor-pointer"><ArrowLeft size={14} /> Boshqa usulni tanlash</button>
